...
class Person
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Person).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Person).void)).returns(::Person) }
    ...
    sig { params(args: T.untyped).returns(T.nilable(::Person)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Person) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Person).void)
      ).returns(T.nilable(T::Enumerator[::Person]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Person]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Person]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Person)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Person) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Person) }
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Person` class because it declared `has_many :user, through: :user_actors`.
    ...
    # This method is created by ActiveRecord on the `Person` class because it declared `has_many :user_actors`.
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Person, T::Enumerable[T.any(::Person, T::Enumerable[::Person])])
    ...
    sig do
      params(
        records: T.any(::Person, Integer, String, T::Enumerable[T.any(::Person, Integer, String, T::Enumerable[::Person])])
      ).returns(T::Array[::Person])
    end
    ...
    sig do
      params(
        other_array: T.any(::Person, T::Enumerable[T.any(::Person, T::Enumerable[::Person])])
      ).returns(T::Array[::Person])
    end
