...
class Notification
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Notification).void)
      ).returns(T.nilable(T::Enumerator[::Notification]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Notification]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Notification]]))
    end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T::Boolean) }
    def read_at_previously_changed?; end
