...
# This is an autogenerated file for dynamic methods in `Circle`.
# Please instead update this file by running `bin/tapioca dsl Circle`.
...
class Circle
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Circle).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Circle).void)).returns(::Circle) }
    ...
    sig { params(args: T.untyped).returns(T.nilable(::Circle)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Circle) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Circle).void)
      ).returns(T.nilable(T::Enumerator[::Circle]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Circle]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Circle]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Circle)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Circle) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Circle) }
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Circle` class because it declared `has_many :ties`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Tie::PrivateCollectionProxy) }
    def ties; end

    sig { params(value: T::Enumerable[::Tie]).void }
    def ties=(value); end
  end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Circle, T::Enumerable[T.any(::Circle, T::Enumerable[::Circle])])
    ...
    sig do
      params(
        records: T.any(::Circle, Integer, String, T::Enumerable[T.any(::Circle, Integer, String, T::Enumerable[::Circle])])
      ).returns(T::Array[::Circle])
    end
    ...
    sig do
      params(
        other_array: T.any(::Circle, T::Enumerable[T.any(::Circle, T::Enumerable[::Circle])])
      ).returns(T::Array[::Circle])
    end
