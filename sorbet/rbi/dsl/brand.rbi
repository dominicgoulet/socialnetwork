...
# Please instead update this file by running `bin/tapioca dsl Brand`.
...
class Brand
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Brand).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Brand).void)).returns(::Brand) }
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::Brand).void)
      ).returns(T.nilable(T::Enumerator[::Brand]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Brand]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Brand]]))
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Brand)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Brand) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Brand) }
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Brand` class because it declared `has_many :user, through: :user_actors`.
    ...
    # This method is created by ActiveRecord on the `Brand` class because it declared `has_many :user_actors`.
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Brand, T::Enumerable[T.any(::Brand, T::Enumerable[::Brand])])
    ...
    sig do
      params(
        records: T.any(::Brand, Integer, String, T::Enumerable[T.any(::Brand, Integer, String, T::Enumerable[::Brand])])
      ).returns(T::Array[::Brand])
    end
    ...
    sig do
      params(
        other_array: T.any(::Brand, T::Enumerable[T.any(::Brand, T::Enumerable[::Brand])])
      ).returns(T::Array[::Brand])
    end
